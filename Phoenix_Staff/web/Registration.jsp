<%-- 
    ...
    Created on : Sep 30, 2022, 4:47:45 PM
    Author     : rashi
--%>
			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">Staff Grade 1 Sign up</h2>
                                ...
                                <form method="post" action="register" class="register-form"
                                        ...
                                        <div class="form-group">
                                                <label for="emp ID"><i class="zmdi zmdi-lock-outline"></i></label>
                                                <input type="text" name="empID" id="contact"
					...
					<div class="signup-image">
						<figure>
							<img src="images/staff-image.jpg" alt="sing up image">
						</figure>
						<a href="Login.jsp" class="signup-image-link">Account already created</a>
					</div>
				</div>
			</div>
		</section>

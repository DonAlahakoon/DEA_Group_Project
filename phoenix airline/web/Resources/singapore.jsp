<%-- 
    Document   : singapore
    Created on : 30-Sep-2022, 09:51:21
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>Phoenix Airline - Singapore</title>
    ...
    <body>
        <div class="page-wrap" id="root">
			...
			<div class="md-content">
							...
							<div class="swiper-wrapper">
								<div class="hero__item" style="background-image: url('./Images/hero/maldives.jpg');"><img src="./Images/hero/maldives.jpg" alt=""/>
									<div class="hero__box_info">
										...
										<div class="container">
										<center>
											<h2 class="hero__title">Singapore</h2>
                ...
                <div class="title">
                    <h2 class="title__title">Welcome to <span class='main-color'>Singapore</span><br /> Reviews and Other journey Details can be able to find here.<br /> <span class='main-color'></span></h2>
									...
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Resources/reviewSection.jsp" style="background-image: url('./Resources/Images/image_box_2/1.jpg');"><img src="./Resources/Images/image_box_2/1.jpg" alt=""/></a>
								...
								<div class="grid-item cat2">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Resources/reviewSection.jsp" style="background-image: url('./Resources/Images/image_box_2/2.jpg');"><img src="./Resources/Images/image_box_2/2.jpg" alt=""/></a>
													<div class="box-image2__info">
								...
								<div class="grid-item cat1">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Resources/reviewSection.jsp" style="background-image: url('./Resources/Images/image_box_2/3.jpg');"><img src="./Resources/Images/image_box_2/3.jpg" alt=""/></a>
													<div class="box-image2__info">

<%-- 
    Document   : ourToursSegment4
    Created on : 30-Sep-2022, 11:32:41
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>Phoenix Airline - China</title>
    ...
    <body>
        <div class="page-wrap" id="root">
			...
			<div class="md-content">
                ...
                <div class="title">
                    <h2 class="title__title">Welcome to <span class='main-color'>China</span><br /> Reviews and Other journey Details can be able to find here.<br /> <span class='main-color'></span></h2>

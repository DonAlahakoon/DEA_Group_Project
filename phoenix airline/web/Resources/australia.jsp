<%-- 
    Document   : australia
    Created on : 30-Sep-2022, 09:50:28
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Phoenix Airline - Australia</title>
    ...
    <body>
        <div class="page-wrap" id="root">
			...
			<div class="md-content">
					...
					<div class="hero__wrapper">
						...
						<div class="swiper__module swiper-container awe-skin-dark hero__main_slider" data-options='{"spaceBetween":0}'>
							<div class="swiper-wrapper">
								<div class="hero__item" style="background-image: url('./Images/countries/australia/1.jpeg');"><img src="./Images/countries/australia/1.jpeg" alt=""/>
									<div class="hero__box_info">
									

										<div class="container">
										<center>
											<h2 class="hero__title">Australia</h2>
											
											<p class="hero__info"><span>From Sri Lanka <br></span><span>Total Reviews</span></p>
										</div>
									</div>
								</div>
                ...
                <div class="title">
                    <h2 class="title__title">Welcome to <span class='main-color'>Australia</span><br /> Reviews and Other journey Details can be able to find here.<br /> <span class='main-color'></span></h2>
                ...
                <section class="awe-section">
					<div class="container">
									...
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/countries/australia/2.jpeg" style="background-image: url('./Images/countries/australia/2.jpeg');"><img src="./Images/countries/australia/2.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">Australia</p>
														<p class="box-image2__tour">The Mekong Boutique River Cruise: in australia</p>
													</div>
													<div class="box-image2__info_bot"><span class="box-image2__date">7 Days / 8 Nights</span><a class="box-image2__view" href="#">5 Stars</a></div>
												</div>
											</div><!-- End / box-image2 -->
								...
								<div class="grid-item cat2">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/countries/australia/3.jpeg" style="background-image: url('./Images/countries/australia/3.jpeg');"><img src="./Images/countries/australia/3.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">Australia</p>
														<p class="box-image2__tour">Classic Vietnam from Ho Chi Minh City</p>
													</div>
													<div class="box-image2__info_bot"><span class="box-image2__date">7 Days / 8 Nights</span><a class="box-image2__view" href="#">4 stars</a></div>
												</div>
											</div><!-- End / box-image2 -->
								...
								<div class="grid-item cat1">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/countries/australia/4.jpeg" style="background-image: url('./Images/countries/australia/4.jpeg');"><img src="./Images/countries/australia/4.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">Australia</p>
														<p class="box-image2__tour">The Silk Road</p>
													</div>
													<div class="box-image2__info_bot"><span class="box-image2__date">7 Days / 8 Nights</span><a class="box-image2__view" href="#">3.5 Stars</a></div>
												</div>
											</div><!-- End / box-image2 -->
						...
						<div class="text-center">
							<a class="md-btn mt-60 md-btn--primary md-btn--pill " href="https://www.viator.com/tours/Sydney/All-Inclusive-Blue-Mountains-Small-Group-Day-Trip-from-Sydney/d357-22584P1?mcid=56757" target="_blank">Explore more
							</a>
						</div>
					</div>
				</section>

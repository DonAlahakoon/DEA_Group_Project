<%-- 
    Document   : japan
    Created on : 30-Sep-2022, 09:50:55
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>Phoenix Airline - Japan</title>
    ...
    <body>
        <div class="page-wrap" id="root">
			...
			<div class="md-content">
                ...
                <div class="title">
                    <h2 class="title__title">Welcome to <span class='main-color'>Japan</span><br /> Reviews and Other journey Details can be able to find here.<br /> <span class='main-color'></span></h2>

<%-- 
    Document   : ourToursSegment1
    Created on : 30-Sep-2022, 11:32:01
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>Phoenix Airline - India</title>
    ...
    <body>
        <div class="page-wrap" id="root">
			...
			<div class="md-content">
                ...
                <div class="title">
                    <h2 class="title__title">Welcome to <span class='main-color'>India</span><br /> Reviews and Other journey Details can be able to find here.<br /> <span class='main-color'></span></h2>

<%-- 
    Document   : ourToursSegment3
    Created on : 30-Sep-2022, 11:32:30
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>Phoenix Airline - Bhuthan</title>
    ...
    <body>
        <div class="page-wrap" id="root">
			...
			<div class="md-content">
							...
							<div class="swiper-wrapper">
								<div class="hero__item" style="background-image: url('./Images/hero/maldives.jpg');"><img src="./Images/hero/maldives.jpg" alt=""/>
									<div class="hero__box_info">
										...
										<div class="container">
										<center>
											<h2 class="hero__title">Bhuthan</h2>
                ...
                <div class="title">
                    <h2 class="title__title">Welcome to <span class='main-color'>Bhuthan</span><br /> Reviews and Other journey Details can be able to find here.<br /> <span class='main-color'></span></h2>

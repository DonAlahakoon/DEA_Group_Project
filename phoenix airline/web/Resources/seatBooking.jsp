<%-- 
    ...
    Created on : 08-Oct-2022, 01:18:01
    Author     : USER
--%>
...
<html>
    ...
    <body>
		<div class="title">
            <h2 class="title__title"><span class='main-color'>Book Your Prefered Seat</span></h2>
        </div><!-- End / title -->

		<div class="title title__style-02">
			<h2 class="title__title">Depature</h2>
		</div><!-- End / title -->
		...
		<div class="container">
			<p class="footer__copy"> <a href=""></a><a href="">Confirm the Depature</a>.</p><span class="footer__backtotop" id="back-to-top"> <a href="" target="_blank"></a></span>
		</div>

		<div class="title title__style-02">
			<h2 class="title__title">Arrival</h2>
		</div><!-- End / title -->
		...
		<div class="container">
			<p class="footer__copy"> <a href=""></a><a href="">Confirm the Arrival</a>.</p><span class="footer__backtotop" id="back-to-top"> <a href="" target="_blank"></a></span>
		</div>
			...
			<div class="box-search-wrapper">
				<div class="container">
					...
					<div class="box-search">
						...
						<!-- form-item -->
						<a class="md-btn md-btn--primary md-btn--pill " href="./mealSelection.jsp" type="submit">Continue 
						</a>

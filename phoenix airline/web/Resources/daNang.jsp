<%-- 
    Document   : daNang
    Created on : 30-Sep-2022, 09:52:07
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>Phoenix Airline - Da Nang</title>
    ...
    <body>
        <div class="page-wrap" id="root">
			...
			<div class="md-content">
					...
					<div class="hero__wrapper">
						...
						<div class="swiper__module swiper-container awe-skin-dark hero__main_slider" data-options='{"spaceBetween":0}'>
							<div class="swiper-wrapper">
								<div class="hero__item" style="background-image: url('./Images/countries/daNang/1.jpeg');"><img src="./Images/countries/daNang/1.jpeg" alt=""/>
									<div class="hero__box_info">
									

										<div class="container">
										<center>
											<h2 class="hero__title">Da Nang</h2>
                ...
                <div class="title">
                    <h2 class="title__title">Welcome to <span class='main-color'>Da Nang</span><br /> Reviews and Other journey Details can be able to find here.<br /> <span class='main-color'></span></h2>
                ...
                <section class="awe-section">
					<div class="container">
									...
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/countries/daNang/2.jpeg" style="background-image: url('./Images/countries/daNang/2.jpeg');"><img src="./Images/countries/daNang/2.jpeg" alt=""/></a>
								...
								<div class="grid-item cat2">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/countries/daNang/3.jpeg" style="background-image: url('./Images/countries/daNang/3.jpeg');"><img src="./Images/countries/daNang/3.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">Da Nang</p>
								...
								<div class="grid-item cat1">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/countries/daNang/4.jpeg" style="background-image: url('./Images/countries/daNang/4.jpeg');"><img src="./Images/countries/daNang/4.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">Da Nang</p>
						...
						<div class="text-center">
							<a class="md-btn mt-60 md-btn--primary md-btn--pill " href="https://vietnam.travel/places-to-go/central-vietnam/da-nang" target="_blank">Explore more
							</a>
						</div>
					</div>
				</section>
				...
				<div class="container">
					...
					<div class="col-md-4 col-lg-4 ">
						...
						<div class="footer__form_wrapper">
							...
							<!-- form-item -->
							<div class="form-item">
								<a class="md-btn footer__btn_custom" onclick="getEmail()" href="#">Subscribe
								</a>
							</div><!-- End / form-item -->

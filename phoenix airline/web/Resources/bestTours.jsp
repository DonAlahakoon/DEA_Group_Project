<%-- 
    Document   : bestTours
    Created on : 30-Sep-2022, 11:19:17
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>Phoenix Airline - Best Tours</title>
    ...
    <body>
        <div class="page-wrap" id="root">
				...
				<div class="container-fluid pd-0">
					<div class="header__inner">
						<div class="header__logo_menu_wrap">
							<div class="header__logo"><a href="./index.html"><img src="./Resources/Images/logo-white.png" alt=""/></a></div>
						</div>
					</div>
				</div>
			</header><!-- End / header -->
			...
			<div class="md-content">
				...
				<div class="hero" id="id-1">
					...
					<div class="swiper__module swiper-container awe-skin-dark hero__main_slider" data-options='{"spaceBetween":0}'>
						<div class="swiper-wrapper">
							<div class="hero__item" style="background-image: url('./Images/countries/India/1.jpeg');"><img src="./Images/countries/India/1.jpeg" alt=""/>
								<div class="hero__box_info">
									<div class="container">
									<center>
										<h2 class="hero__title">Best Tours</h2>
										
										<p class="hero__info"><span>All Around The World<br></span></p>
									</div>
								</div>
							</div>
                ...
                <div class="title">
                    <h2 class="title__title">Welcome to <span class='main-color'>Phoenix Airline</span><br /> Find out most available Hotels, and enjoy you direct journey throughout<br /> <span class='main-color'>Asia</span> .The reliability was the main key feature we care about.</h2>
					...
					<div class="box-search-wrapper">
						<div class="container">
							...
							<div class="box-search">
								...
								<a class="md-btn md-btn--primary md-btn--pill " href="./ticketBooking.jsp">Filter
								</a>
							</div><!-- End / box-search -->
				...
				<section class="awe-section">
					<div class="container">
						...
						<div class="title title__style-02">
							<h2 class="title__title">Best Tours | Best Reviewed</h2>
						</div><!-- End / title -->
						...
						<div class="grid-css grid_css_style_02 grid-css--masonry" data-col-lg="3" data-col-md="2" data-col-sm="2" data-col-xs="1" data-gap="30">
							<div class="filter">
								<ul class="filter__list">
									...
									<li><a href="#" data-filter=".cat1">Luxurious</a></li>
									<li><a href="#" data-filter=".cat2">General</a></li>
								</ul>
							</div>
									...
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/Hotels/1.jpeg" style="background-image: url('./Images/Hotels/1.jpeg');"><img src="./Images/Hotels/1.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">Burj Al Arab</p>
														<p class="box-image2__tour">Dubai</p>
													</div>
								...
								<div class="grid-item cat2">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/Hotels/2.jpeg" style="background-image: url('./Images/Hotels/2.jpeg');"><img src="./Images/Hotels/2.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">Ritz-carlton</p>
														<p class="box-image2__tour">Hong Kong</p>
													</div>
													<div class="box-image2__info_bot"><span class="box-image2__date">7 Days / 8 Nights</span><a class="box-image2__view" href="#">View tour</a></div>
												</div>
											</div><!-- End / box-image2 -->
								...
								<div class="grid-item cat1">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/Hotels/3.jpeg" style="background-image: url('./Images/Hotels/3.jpeg');"><img src="./Images/Hotels/3.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">Araliya</p>
														<p class="box-image2__tour">Unawatuna</p>
													</div>
													<div class="box-image2__info_bot"><span class="box-image2__date">7 Days / 8 Nights</span><a class="box-image2__view" href="#">View tour</a></div>
												</div>
											</div><!-- End / box-image2 -->
								...
								<div class="grid-item cat2">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/Hotels/4.jpeg" style="background-image: url('./Images/Hotels/4.jpeg');"><img src="./Images/Hotels/4.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">Hilton</p>
														<p class="box-image2__tour">Comlombo 7</p>
													</div>
													<div class="box-image2__info_bot"><span class="box-image2__date">7 Days / 8 Nights</span><a class="box-image2__view" href="#">View tour</a></div>
												</div>
											</div><!-- End / box-image2 -->
								...
								<div class="grid-item cat1">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/Hotels/5.jpeg" style="background-image: url('./Images/Hotels/5.jpeg');"><img src="./Images/Hotels/5.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">Hotel Ritz</p>
														<p class="box-image2__tour">Paris</p>
													</div>
													<div class="box-image2__info_bot"><span class="box-image2__date">7 Days / 8 Nights</span><a class="box-image2__view" href="#">View tour</a></div>
												</div>
											</div><!-- End / box-image2 -->
								...
								<div class="grid-item cat2">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/Hotels/6.jpeg" style="background-image: url('./Images/Hotels/6.jpeg');"><img src="./Images/Hotels/6.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">Claridge's London</p>
														<p class="box-image2__tour">London</p>
													</div>
													<div class="box-image2__info_bot"><span class="box-image2__date">7 Days / 8 Nights</span><a class="box-image2__view" href="#">View tour</a></div>
												</div>
											</div><!-- End / box-image2 -->
                ...
                <div class="container">
					...
					<!-- Section -->
					<section class="awe-section awe-skin-dark bg-fixed style-03" style="background-image:url(./Images/bg/christmas.jpg);">
                ...
                <div class="title">
                    <h2 class="title__title"><span class='main-color'>Unique Journeys with Unique Experiances</span><br /><br /> <span class='main-color'></span></h2>
					...
					<div class="container">
						...
						<div class="grid-css grid_css_style_02 grid-css--masonry" data-col-lg="3" data-col-md="2" data-col-sm="2" data-col-xs="1" data-gap="30">
							<div class="filter">
								<ul class="filter__list">
									<li><a href="#" data-filter="*">All</a></li>
									<li><a href="#" data-filter=".cat1">Five Star</a></li>
									<li><a href="#" data-filter=".cat2">Below</a></li>
								</ul>
							</div>
							<div class="grid__inner">
								<div class="grid-sizer"></div>
								<div class="grid-item cat1">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/countries/bhuthan/1.jpeg" style="background-image: url('./Images/countries/bhuthan/1.jpeg');"><img src="./Images/countries/bhuthan/1.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">Bhuthan</p>
														<p class="box-image2__tour">The Mekong Boutique River Cruise: Laos to Bhuthan</p>
													</div>
													<div class="box-image2__info_bot"><span class="box-image2__date">7 Days / 8 Nights</span><a class="box-image2__view" href="#">View tour</a></div>
												</div>
											</div><!-- End / box-image2 -->
								...
								<div class="grid-item cat2">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/countries/Istanbul/1.jpeg" style="background-image: url('./Images/countries/Istanbul/1.jpeg');"><img src="./Images/countries/Istanbul/1.jpeg" alt=""/></a>
													<div class="box-image2__info">
								...
								<div class="grid-item cat1">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/countries/albania/1.jpeg" style="background-image: url('./Images/countries/albania/1.jpeg');"><img src="./Images/countries/albania/1.jpeg" alt=""/></a>
													<div class="box-image2__info">
								...
								<div class="grid-item cat2">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/countries/china/1.jpeg" style="background-image: url('./Images/countries/china/1.jpeg');"><img src="./Images/countries/china/1.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">China</p>
														<p class="box-image2__tour">Dubai & China Vacation incl. Airfare</p>
													</div>
													<div class="box-image2__info_bot"><span class="box-image2__date">7 Days / 8 Nights</span><a class="box-image2__view" href="#">View tour</a></div>
												</div>
											</div><!-- End / box-image2 -->
								...
								<div class="grid-item cat2">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<!-- box-image2 -->
											<div class="box-image2">
												<div><a class="box-image2__bg" href="./Images/countries/Maldives/1.jpeg" style="background-image: url('./Images/countries/Maldives/1.jpeg');"><img src="./Images/countries/Maldives/1.jpeg" alt=""/></a>
													<div class="box-image2__info">
														<p class="box-image2__country">Maldives</p>
														<p class="box-image2__tour">Maldives Odyssey with Yangtze River Cruise</p>
													</div>
													<div class="box-image2__info_bot"><span class="box-image2__date">7 Days / 8 Nights</span><a class="box-image2__view" href="#">View tour</a></div>
												</div>
											</div><!-- End / box-image2 -->
                        ...
                        <div class="title">
                            <h2 class="title__title">For More Let's Sign you in.<span class='main-color'></span><br /><br /> <span class='main-color'></span></h2>
                            <p class="title__text"></p>
                        </div><!-- End / title -->
        
                        <div class="text-center">
                            <a class="md-btn mt-60 md-btn--primary md-btn--pill " href="../secondIndex.jsp">Back
                            </a>
                            <a class="md-btn mt-60 md-btn--primary md-btn--pill " href="./DEA_Group_Project-Sign-in-up-2 - imesh/index.php">Sign In
                            </a>
                            <a class="md-btn mt-60 md-btn--primary md-btn--pill " href="./DEA_Group_Project-Sign-in-up-2 - imesh/index.php">Sign Up
                            </a>
                        </div>
					</div>
				</section>

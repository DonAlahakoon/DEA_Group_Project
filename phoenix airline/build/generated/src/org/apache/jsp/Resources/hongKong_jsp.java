...
public final class hongKong_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Phoenix Airline - Hong Kong</title>\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"hero__item\" style=\"background-image: url('./Images/countries/Maldives/1.jpeg');\"><img src=\"./Images/countries/hongKong/1.jpeg\" alt=\"\"/>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"hero__box_info\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"container\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<center>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<h2 class=\"hero__title\">Hong Kong</h2>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\n");
      ...
      out.write("                    <h2 class=\"title__title\">Welcome to <span class='main-color'>Hong Kong</span><br /> Reviews and Other journey Details can be able to find here.<br /> <span class='main-color'></span></h2>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div><a class=\"box-image2__bg\" href=\"./Resources/reviewSection.jsp\" style=\"background-image: url('./Images/countries/hongKong/2.jpeg');\"><img src=\"./Images/countries/hongKong/2.jpeg\" alt=\"\"/></a>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<!-- box-image2 -->\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"box-image2\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div><a class=\"box-image2__bg\" href=\"./Resources/reviewSection.jsp\" style=\"background-image: url('./Images/countries/hongKong/3.jpeg');\"><img src=\"./Images/countries/hongKong/2.jpeg\" alt=\"\"/></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"box-image2__info\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"box-image2__country\">Hong Kong</p>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<!-- box-image2 -->\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"box-image2\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div><a class=\"box-image2__bg\" href=\"./Resources/reviewSection.jsp\" style=\"background-image: url('./Images/countries/hongKong/4.jpeg');\"><img src=\"./Images/countries/hongKong/4.jpeg\" alt=\"\"/></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"box-image2__info\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"box-image2__country\">Hong Kong</p>\n");
      ...
      out.write("\t\t\t\t\t\t\t<a class=\"md-btn mt-60 md-btn--primary md-btn--pill \" href=\"https://en.wikipedia.org/wiki/Hong_Kong_Tourism_Board\" target=\"_blank\">Explore more\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</section>\n");
